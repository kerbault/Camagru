	...
	<div class="center">
		...
		<div class="logForm">
			<form style="width: 100%" action="./index.php?action=changePasswd" method="post">
				<p>Old password</p>
				<input type="password" class="logInput" name="passwd" id="oldPasswd" placeholder="ex : NoTh4tEz"
					   pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,50}"
					   title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
					   required>
				<p>New password</p>
				<input type="password" class="logInput" name="passwd" id="newPasswd" placeholder="ex : NoTh4tEz"
					   pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,50}"
					   title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
					   required>
